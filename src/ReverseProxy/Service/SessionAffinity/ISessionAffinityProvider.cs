...
namespace Microsoft.ReverseProxy.Service.SessionAffinity
{
    ...
    public interface ISessionAffinityProvider
    {
        ...
        public AffinityResult FindAffinitizedDestinations(HttpContext context, IReadOnlyList<IDestination> destinations, string clusterId, in ClusterConfig.ClusterSessionAffinityOptions options);
        ...
        public void AffinitizeRequest(HttpContext context, in ClusterConfig.ClusterSessionAffinityOptions options, IDestination destination);
    }
}
